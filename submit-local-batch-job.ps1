...
# Uploading whl file
$localPackagePath = (Resolve-Path(Join-Path $here "./dist/$PackageName-0.1.0-py3-none-any.whl")).Path
$packageDestinationRelativePath = "/local-artifacts/packages/$PackageName-0.1.0-py3-none-any.whl"
